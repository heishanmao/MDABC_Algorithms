 ...
 % @LastEditTime: 2022-03-02 22:41:00
 % @FilePath: \Code\Exp3_SPEA_Gurobi.m
 % @Description: 
 % @
...
for j = 1:5 % results only for J10 instance
    ...
    for i = 1:5
        ...
        % legend([NAME,'-FF'],[NAME,'-Johnson'],[NAME,'-LPT'],[NAME,'-SPT'],'GUROBI');
        xlabel('$C_{max}$','Interpreter','latex')
        ylabel('$TEC$','Interpreter','latex')           
