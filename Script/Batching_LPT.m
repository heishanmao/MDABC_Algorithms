 ...
 % @LastEditTime: 2022-03-02 22:52:15
 % @FilePath: \Code\Script\Batching_LPT.m
 % @Description: 
 % @
 % @Copyright (c) 2022 by Scott Zheng, All Rights Reserved. 
 %% 
function [Batch, Cmax, TEC] = Batching_LPT(Instance, B, PlotSwitch)
    %  Longest Processing time batching on the first machine
