 ...
 % @LastEditTime: 2022-03-02 22:43:27
 % @FilePath: \Code\Function\Main_SPEA_Johnson.m
 % @Description: 
 % @
...
function [Pareto,time] = Main_SPEA_Johnson(Instance, B, SN, MutProbabili, ITERATION, PLOT)
% M = 20; %初始种群的大小
% SN = 30; %子代种群的大小
% B = 10; %机器容量
% ITERATION = 200; %迭代次数
