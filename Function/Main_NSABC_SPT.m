 ...
 % @LastEditTime: 2022-03-02 22:43:00
 % @FilePath: \Code\Function\Main_NSABC_SPT.m
 % @Description: 
 % @
...
function [Pareto,time] = Main_NSABC_SPT(Instance, B, SN, OnlookerBee,ScoutBee, ITERATION, PLOT)
...
% PLOT = true;
    ...
    for i = 1:SN*2
        ...
        [Pop0{i,2}, Pop0{i,3}, Pop0{i,4}] = Batching_SPT(Pop0{i,1,1}, B, false);
    end
    ...
    for i = 2:ITERATION
        ...
        %% FF batching
        for j = 1:SN
            [POP{j,2}, POP{j,3}, POP{j,4}] = Batching_SPT(POP{j,1}, B, false); % update results
        end
