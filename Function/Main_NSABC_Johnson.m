 ...
 % @LastEditTime: 2022-03-02 22:42:41
 % @FilePath: \Code\Function\Main_NSABC_Johnson.m
 % @Description: 
 % @
...
function [Pareto,time] = Main_NSABC_Johnson(Instance, B, SN, OnlookerBee,ScoutBee, ITERATION, PLOT)
...
% PLOT = true;
    ...
    for i = 1:SN*2
        ...
        [Pop0{i,2}, Pop0{i,3}, Pop0{i,4}] = Batching_Johnson(Pop0{i,1,1}, B, false);
    end
