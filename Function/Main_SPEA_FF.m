 ...
 % @LastEditTime: 2022-03-02 22:43:22
 % @FilePath: \Code\Function\Main_SPEA_FF.m
 % @Description: 
 % @
...
function [Pareto,time] = Main_SPEA_FF(Instance, B, SN, MutProbabili, ITERATION, PLOT)
% M = 20; %初始种群的大小
% SN = 30; %子代种群的大小
% B = 10; %机器容量
% ITERATION = 200; %迭代次数
...
tic
    ...
    for i = 1:SN*2
        ...
        [Pop0{i,2}, Pop0{i,3}, Pop0{i,4}] = Batching_FirstFit(Pop0{i,1}, B, false);
    end
